    ...
    function applySpooferToObj(obj)
        ...
        elseif obj:IsA("ImageLabel") or obj:IsA("ImageButton") then
            function updateImage()
                ...
                if changed and obj.Image ~= (PANDU_CUSTOM_ICON:find("rbxassetid://") and PANDU_CUSTOM_ICON or "rbxassetid://" .. PANDU_CUSTOM_ICON) then
                    obj.Image = (PANDU_CUSTOM_ICON:find("rbxassetid://") and PANDU_CUSTOM_ICON or "rbxassetid://" .. PANDU_CUSTOM_ICON)
                end
            end
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/arga0419-bot/kiw/refs/heads/main/Library_pandu_logo_fix.lua"))()
...
-- ===== CUSTOM LOGO =====
-- Ganti nilai ini dengan Roblox Image/Decal Asset ID dari foto 256.jpg.
-- Logo ini dipakai untuk logo utama dan tombol floating mobile.
local PANDU_CUSTOM_ICON = "111387348661729"

-- Black / gray color scheme
Library.Scheme.AccentColor     = Color3.fromRGB(170, 170, 175)
Library.Scheme.BackgroundColor = Color3.fromRGB(10, 10, 12)
Library.Scheme.MainColor       = Color3.fromRGB(24, 24, 27)
Library.Scheme.OutlineColor    = Color3.fromRGB(70, 70, 75)
Library.Scheme.FontColor       = Color3.fromRGB(225, 225, 230)

local Window = Library:CreateWindow({
    Title = "Pandu Hub",
    Footer = 'Violence District v2.4.0 | https://discord.gg/panduhub',
    Icon = PANDU_CUSTOM_ICON,
