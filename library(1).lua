...
-- PANDU LOGO FIX
-- Keep the original icon system intact. Custom asset IDs are returned as-is,
-- while Lucide icons (house, users, swords, eye, map-pin, settings, etc.)
-- continue to use the normal Lucide assets.
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        if WindowInfo.Icon then
            ...
            -- Force the main window logo without tint.
            if WindowInfo.Title == "Pandu Hub" then
                Icon = { Url = "rbxassetid://111387348661729", ImageRectOffset = Vector2.zero, ImageRectSize = Vector2.zero, Custom = true }
            end
